          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Founded in 2018, Sheenedge began with a simple mission: to create digital experiences that truly matter.
                What started as a small team of three passionate developers has grown into a full-service digital agency
        ...
        <div className="container max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">
                Visionary leader with 15+ years of experience in digital product development.
              </p>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">
                Award-winning designer with a passion for creating beautiful and functional interfaces.
              </p>
              <div className="flex justify-center space-x-3">
                <a href="#" className="text-gray-400 hover:text-blue-600 transition-colors">
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">
                Tech visionary with expertise in AI, cloud architecture, and emerging technologies.
              </p>
              <div className="flex justify-center space-x-3">
                <a href="#" className="text-gray-400 hover:text-blue-600 transition-colors">
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
